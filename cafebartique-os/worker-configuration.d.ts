/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 335d6ecf091520f21c121eb003a1c662)
// Runtime types generated with workerd@1.20260706.1 2026-07-07 nodejs_compat
interface __BaseEnv_Env {
	TOAST_TOKEN_CACHE: KVNamespace;
	ANALYTICS_CACHE: KVNamespace;
	TOAST_CLIENT_ID: string;
	TOAST_CLIENT_SECRET: string;
	TOAST_RESTAURANT_ID: string;
	TOAST_HOST: string;
	TOAST_ACCESS_TYPE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOAST_CLIENT_ID" | "TOAST_CLIENT_SECRET" | "TOAST_RESTAURANT_ID" | "TOAST_HOST" | "TOAST_ACCESS_TYPE">> {}
}
